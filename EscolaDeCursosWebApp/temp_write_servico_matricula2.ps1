$path = 'c:\Users\gutes\OneDrive\Desktop\Super Pasta\Academia do Programador\EscolaDeCursos\EscolaDeCursosWebApp\Modulos\ModuloMatricula\Aplicacao\ServicoMatricula.cs'
$content = @'
using System;
using System.Linq;
